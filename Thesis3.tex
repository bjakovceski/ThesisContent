...
\section{Data pre-processing}\label{dataPreProcessing}
	First of all, we downloaded 2 datasets from DBpedia NIF Datasets (for more information about DBpedia NIF see Section~\ref{DBpediaNIF}) for the English language in .ttl format. We needed only 2 datasets, and that nif-context (or nif-abstract-context) and nif-text-links.
